...
export const IANA_APPLICATION_TYPES = [
  ...
  'application/vnd.gov.sk.e-form+xml (OBSOLETED by request)',
...
export const IANA_MESSAGE_TYPES = [
  'message/bhttp',
  'message/CPIM',
...
export const IANA_MULTIPART_TYPES = [
